...
const instructionsThree = [
  ...
  {
    top: <p>"Hi! Can you help me finish packing for school? I still need a <strong>backpack</strong> to store all my things. My mom said I need new <strong>glasses</strong> to help me see the board better. I also need some <strong>#2 pencils</strong> and <strong>a notebook</strong> to take notes in, and <strong>glue</strong> for projects. I think that's all that I'm missing, thank you!"</p>
  }
];
